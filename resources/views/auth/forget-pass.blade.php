...
<div>
    <h3 class="text-xl md:text-2xl font-bold text-center mb-4  md:mb-8">Forgot Password</h3>
</div>
<form class="space-y-6" id="data_form">
  ...
  <div id="toast-danger" class=" hidden items-center w-full p-4 mb-4 text-black bg-white rounded-lg shadow " role="alert">
    ...
    <div>
      <label for="email" class="block text-sm md:text-base font-medium text-gray-900">Email address</label>
      <div class="mt-2">
        <input id="email" placeholder="Enter Your Email..." name="email" type="email" autocomplete="email" required class="block w-full rounded-md border-2 border-gray-300 py-2.5 px-3  ring-0 focus:ring-0 text-gray-900 shadow-sm  placeholder:text-gray-500 text-sm  sm:text-base font-medium">
      </div>
    </div>
