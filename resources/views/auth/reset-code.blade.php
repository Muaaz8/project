...
<div>
    <h3 class="text-xl md:text-2xl font-bold text-center mb-4  md:mb-8">Password Reset Verification</h3>
</div>
<form class="space-y-6" id="data_form">
    @if (session()->has('reset_code'))
    <div id="toast-successaaa" class="flex items-center w-full p-4 mb-4 text-black bg-white rounded-lg shadow " role="alert" >
        ...
        <div class="ms-3 text-base font-medium tracking-wider">Enter the code sent to your email</div>
        <button type="button" class="ms-auto -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex items-center justify-center h-8 w-8 dark:text-gray-500 dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700" data-dismiss-target="#toast-successaaa" aria-label="Close">
  ...
  <div id="toast-danger" class=" hidden items-center w-full p-4 mb-4 text-black bg-white rounded-lg shadow " role="alert">
    ...
    <div>
      <label for="email" class="block text-sm md:text-base font-medium text-gray-900">OTP Code</label>
      <div class="mt-2">
        <input id="email" placeholder="Enter the code..." name="otp" type="text"  required class="block w-full rounded-md border-2 border-gray-300 py-2.5 px-3  ring-0 focus:ring-0 text-gray-900 shadow-sm  placeholder:text-gray-500 text-sm  sm:text-base font-medium">
      </div>
    </div>
...
e.preventDefault();
$("#toast-successaaa").removeClass('flex').addClass('hidden');
